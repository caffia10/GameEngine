...
inline f32 GetDeterminantOfCell(const Matrix4& matrix, i8 rowToExclud, i8 columnToExclud)
{
	Matrix3 subMatrix;
	i8 currentCell = 0;
...
inline f32 GetDeterminant(const Matrix4& matrix)
{
	// we chose get the determinant with first column
...
inline Matrix4 GetAdjointMatrix(const Matrix4& matrix)
{
	i8 multiplier = 1;
...
inline Matrix4 GetInverseMatrix(const Matrix4& matrix)
{
